...
namespace CODE_BLOG__12._2_Generic_Шаблон__база_
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // примеру тип "int" и везде где был тип "T" прописывается "int". Тоесть это дает нам возможность динамически изменять
            // типизацию, но при этом мы остаемся строго типизированными.
            // Обобщения используем -когда тебе понадобится тип данных не на этапе проектирования класса, а на этапе его использования.
